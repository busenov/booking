...
#apt-get install -y php7.4 php7.4-curl php7.4-cli php7.4-intl php7.4-mysqlnd php7.4-gd php7.4-fpm php7.4-mbstring php7.4-xml unzip nginx mariadb-server php.xdebug php7.4-zip php7.4-bcmath
apt-get install -y php7.4 php7.4-curl php7.4-cli php7.4-intl php7.4-mysqlnd php7.4-gd php7.4-fpm php7.4-mbstring php7.4-xml unzip nginx mariadb-server php.xdebug php7.4-zip php7.4-bcmath
...
sed -i 's/;date.timezone =/date.timezone = Europe\/Moscow/g' /etc/php/7.4/cli/php.ini
#fpm
sed -i 's/short_open_tag = Off/short_open_tag = On/g' /etc/php/7.4/fpm/php.ini
sed -i 's/;date.timezone =/date.timezone = Europe\/Moscow/g' /etc/php/7.4/fpm/php.ini
echo "Done!"
